(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        function closeAllSubmenus() {
            ...
            allSubmenus.forEach((submenu => {
                ...
                const arrow = submenu.previousElementSibling.querySelector(".drop-list__arrow");
        ...
        dropLists.forEach((dropList => {
            dropList.addEventListener("click", (function(e) {
                ...
                const arrow = this.querySelector(".drop-list__arrow");
    ...
    gsap.utils.toArray(".subtext").forEach((subtext => {
        const chars = subtext.querySelectorAll(".char");
        gsap.timeline({
            scrollTrigger: {
                trigger: subtext,
                start: "top 80%",
    ...
    gsap.registerPlugin(ScrollTrigger);
    const gsapItem = gsap.utils.toArray(".subtext-main");
    gsapItem.forEach((subtextMain => {
        const textChar = subtextMain.querySelectorAll(".char");
    ...
    gsap.from(".performance__button", {
        scrollTrigger: {
            trigger: ".performance__button",
            start: "top 90%",
            end: "bottom 80%",
            toggleActions: "play none none none"
        },
    ...
    gsap.from(".bottom-episodes__button", {
        scrollTrigger: {
            trigger: ".bottom-episodes__button",
            start: "top 100%",
            end: "top top",
            toggleActions: "play none none none"
        },
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.utils.toArray(".infinite-scroll__row").forEach((row => {
        gsap.from(row, {
            duration: 1,
            autoAlpha: 0,
            delay: 1.9,
    ...
    gsap.registerPlugin(ScrollTrigger);
    const supportedAppAnimation = gsap.timeline({
        scrollTrigger: {
            trigger: ".supported-app",
    ...
    supportedAppAnimation.from(".supported-app__container", {
        duration: 1,
        scale: .7,
        rotationX: -45,
        rotationY: 45,
    ...
    supportedAppAnimation.staggerFrom(".supported-app__items img", 1, {
        duration: .6,
        scale: 0,
        rotationX: -90,
        rotationY: 90,
    ...
    supportedAppAnimation.from(".supported-app__text", {
        duration: 1,
        y: 50,
        autoAlpha: 0,
        ease: "expo.out"
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.utils.toArray(".inspiration-pulse__item").forEach((item => {
        gsap.from(item, {
            autoAlpha: 0,
            scale: .7,
            duration: 1,
    ...
    gsap.from(".quote__bottom", {
        ...
        ease: "power2.out",
        scrollTrigger: {
            trigger: ".quote__bottom",
            start: "top 95%",
            toggleActions: "play none none none"
        }
    });
    gsap.from(".quote__decoration", {
        scale: 0,
        opacity: 0,
        duration: 1,
        stagger: .2,
    ...
    function animateBenefits() {
        const items = gsap.utils.toArray(".column__item");
    ...
    gsap.from(".bottom-benefits__button", {
        scrollTrigger: {
            trigger: ".bottom-benefits__button",
            start: "top 100%",
            toggleActions: "play none none none"
        },
        duration: .4,
    ...
    function animateEpisodes() {
        const items = document.querySelectorAll(".col__item");
        items.forEach(((item, index) => {
            gsap.from(item, {
                scrollTrigger: {
                    trigger: item,
    ...
    animateEpisodes();
    gsap.registerPlugin(ScrollTrigger);
    gsap.utils.toArray(".column-price__box").forEach((box => {
        gsap.from(box.querySelector(".top-plan__lable"), {
            opacity: 0,
            y: -20,
            duration: .5,
            scrollTrigger: {
        ...
        gsap.from(box.querySelector(".top-plan__description"), {
            opacity: 0,
            y: -20,
            duration: .5,
            delay: .2,
        ...
        gsap.from(box.querySelector(".top-plan__price"), {
            opacity: 0,
            y: -20,
            duration: .5,
            delay: .4,
        ...
        gsap.from(box.querySelectorAll(".include__item"), {
            opacity: 0,
            y: -20,
            duration: .5,
            stagger: .1,
    ...
    gsap.registerPlugin(ScrollTrigger);
    gsap.utils.toArray(".news-column__box").forEach(((box, i) => {
        gsap.fromTo(box, {
            opacity: 0,
            y: 20
        }, {
    ...
    gsap.registerPlugin(ScrollTrigger);
    function floatingAnimation(selector, amplitude, speed) {
        gsap.to(selector, {
            y: amplitude,
            ease: "sine.inOut",
            duration: speed,
    ...
    floatingAnimation(".decor-dowload__item--sparkle-big", 15, 6);
    floatingAnimation(".decor-dowload__item--sparkle-mid", -15, 6);
    floatingAnimation(".decor-dowload__item--sparkle-small", 10, 5);
    gsap.fromTo(".link-dowload__button", {
        scale: .9
    }, {
        scale: 1.1,
        duration: 1,
    ...
    gsap.registerPlugin(ScrollTrigger);
    const quotes = document.querySelectorAll(".swiper-slide");
    quotes.forEach((quote => {
        const text = quote.querySelector(".swiper-slide__text");
        const author = quote.querySelector(".swiper-slide__author");
        const app = quote.querySelector(".swiper-slide__app");
